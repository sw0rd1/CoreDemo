            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContactID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConcatUsername = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcatMail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcatSubjet = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcatMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcatDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ConcatStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Concats", x => x.ContactID);
                });
